  ...
  return (
    <>
      ...
      <section id="brief" className="scroll-mt-24">
        ...
        <div className="rounded-card border-l-[3px] border-coral bg-mist p-6 mb-6">
          <p className="eyebrow text-coral mb-2">The problem</p>
          <p className="font-body text-body text-ink leading-[1.7]">
            {project.problem}
          </p>
        </div>

        <div className="rounded-card border-l-[3px] border-ink bg-mist p-6">
          <p className="eyebrow text-caption mb-2">The goal</p>
          <p className="font-body text-body text-ink leading-[1.7]">
            {project.goal}
          </p>
        </div>
        ...
        <section id="tech-stack" className="scroll-mt-24">
          ...
          <div className="grid gap-3 md:grid-cols-2">
            {project.techStack.map((t, i) => (
              <article
                key={t.name}
                className="rounded-card border border-rule bg-mist p-5"
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="mt-1 font-body text-body text-muted leading-[1.6]">
                      {t.why}
                    </p>
                  </div>
                </div>
