  ...
  return (
    <>
      ...
      <section id="brief" className="scroll-mt-24">
        ...
        <div className="rounded-2xl border-l-[3px] border-coral bg-mist p-6 mb-6">
        ...
        <div className="rounded-2xl border-l-[3px] border-ink bg-mist p-6">
            ...
            {project.techStack.map((t, i) => (
              ...
              >
                <div className="flex items-start gap-3">
                  <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-coral/10 font-display italic text-coral">
                    {i + 1}
                  </span>
                  <div className="flex-1 min-w-0">
                    <p className="font-body font-semibold text-ink">{t.name}</p>
