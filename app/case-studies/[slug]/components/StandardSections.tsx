  ...
  return (
    <>
      ...
      <section id="goal" className="scroll-mt-24">
        ...
        <div className="rounded-card border-l-[3px] border-coral bg-stone p-6">
      ...
      <section id="research" className="scroll-mt-24">
        ...
        <ol role="list" className="flex flex-col gap-3">
          {project.research.keyFindings.map((f, i) => (
            <li key={i} className="rounded-card border border-stone bg-stone p-5">
      ...
      <section id="insights" className="scroll-mt-24">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          {project.insights.map((ins, i) => (
            <div key={i} className="rounded-card border border-stone bg-stone p-6">
      ...
      <section id="design" className="scroll-mt-24">
        ...
        <div className="flex flex-col gap-4 mb-10">
          {project.iterations.map((it, i) => (
            <div
              key={i}
              className="rounded-card border border-stone bg-paper p-6"
            >
        ...
        <div className="grid gap-5 md:grid-cols-3 mb-6">
          {/* Colors */}
          <div className="rounded-card border border-stone bg-stone p-5">
              ...
              {project.designSystem.colors.map(c => {
                ...
                return (
                  <li key={c} className="flex items-center gap-2.5">
                    <span
                      className="h-5 w-5 shrink-0 rounded border border-stone"
